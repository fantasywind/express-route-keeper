    ...
    switch (aclMode) {
      case ACL_OR_MODE:
        if (!_lodash2.default.intersection(acl, req.aclActions).length) {
          debugACL('ACL: need at least one action in: ' + acl.map(function (action) {
...
var debugACL = (0, _debug2.default)('RouteKeeper:ACL');
var debugParams = (0, _debug2.default)('RouteKeeper:Parameters');
